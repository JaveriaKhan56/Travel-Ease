                ...
                <form class="custom-form member-login-form" action="#" method="post" role="form">
                    ...
                    <div class="member-login-form-body">
                        <div class="mb-4">
                            ...
                            <input type="email" name="member-login-number" id="member-login-number" class="form-control" placeholder="Email ID" required>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <h2 class="mb-lg-5 mb-4">Solo Packages</h2>
                    </div>
...
// SELECT td.*, tp.*
// FROM travelling_Details td
// JOIN travel_packages tp ON td.PackageID = tp.PackageID
// WHERE tp.PackageType = 'solo';

// Fetch travel packages with type 'solo'
$query = "SELECT * FROM travel_packages WHERE PackageType = 'solo'";
$data = mysqli_query($conn, $query);

while ($row = mysqli_fetch_assoc($data)) {
    // Fetch the user ID from the users table (this example assumes a single user for demonstration purposes)

 // Adjust this query based on your logic
            ...
            <div class="card-body p-0 border-0">
                <div class="col-12 d-flex">
                    <div class="custom-btn-wrap col-6 rounded-0" style="background-color: #81B29A;">
                        <form action="soloPackageDetails.php" class="w-100 bttn pb-0" method="get">
                     ...
                     <div class="col-lg-6 col-12 mb-5 mb-lg-4">
                        <div class="card border-0 position-relative rounded-top-5">
                            <a href="#" class="packagesImageWrapper">
                                ...
                                <img height="400px" src="./images/solopakis.webp"
                            ...
                            <div class="custom-block-info border-0">
                                <a href="event-detail.html" class="align-items-center justify-content-center d-flex events-title mb-2">Maxico Tour</a>
                    ...
                    <!-- <div class="col-lg-6 col-12 mb-5 mb-lg-4">
                        <div class="card border-0 position-relative rounded-top-5">
                            <a href="#" class="packagesImageWrapper">
                                ...
                                <img height="400px" src="./images/soloL.jpg"
                                    class="card-img-top rounded-top-5" alt="...">
                            </a>
                            ...
                            <div class="custom-block-info">
                                <a href="event-detail.html" class="events-title mb-2">London Tour</a>
                   ...
                   <div class="col-lg-6 col-12 mb-5 mb-lg-4">
                        <div class="card border-0 position-relative rounded-top-5">
                            <a href="" class="packagesImageWrapper">
                                ...
                                <img height="400px" src="./images/solop.jpg"
                                    class="card-img-top rounded-top-5" alt="...">
                            </a>
                 ...
                 <!--    <div class="col-lg-6 col-12 mb-5 mb-lg-4">
                        <div class="card border-0 position-relative rounded-top-5">
                            <a href="#" class="packagesImageWrapper">
                                ...
                                <img height="400px" src="./images/solod.avif"
                                    class="card-img-top rounded-top-5" alt="...">
                            </a>
                            ...
                            <div class="custom-block-info">
                                <a href="event-detail.html" class="events-title mb-2">Dubai Tour</a>
        ...
        <section class="events-section events-listing-section section-bg section-padding" id="section_3">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <h2 class="mb-3">Upcoming Solo Travel Packages</h2>
                    </div>
                    ...
                    <div class="row custom-block mb-3">
                        ...
                        <div class="col-lg-6 col-12 order-3 order-lg-0">
                            <div class="custom-block-info mt-2 mt-lg-0">
                                ...
                                <p class="mb-0">You can browse many different categories of CSS templates using <a href="https://templatemo.com/tag" target="_blank">tags</a> on TemplateMo
