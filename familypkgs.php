            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="index.html#section_4">Customize</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                <li><a class="dropdown-item active" href="../TravelEase/Our_Packages.php">Solo Packages</a></li>

                                <li><a class="dropdown-item" href="">Couple Packages</a></li>
                ...
                <form class="custom-form member-login-form" action="#" method="post" role="form">
                    ...
                    <div class="member-login-form-body">
                        <div class="mb-4">
                            ...
                            <input type="email" name="member-login-number" id="member-login-number" class="form-control"
        ...
        <section class="events-section section-padding" id="section_2">
            ...
            <div class="row">
                    <div class="col-lg-12 col-12">
                        <h2 class="mb-lg-5 mb-4">Family Packages</h2>
                    </div>
                    <?php
                    $query = "SELECT * FROM travel_packages WHERE PackageType = 'family'";
            ...
            <div class="card-body p-0 border-0">
                <div class="col-12 d-flex">
                    <div class="custom-btn-wrap col-6 rounded-0" style="background-color: #81B29A;">
                        <form action="familyPackageDetails.php" class="w-100 bttn pb-0" method="get">
                    ...
                    <div class="col-lg-6 col-12 mb-5 mb-lg-4">
                        <div class="card border-0 position-relative rounded-top-5">
                            <a href="#" class="packagesImageWrapper">
                                ...
                                <img height="400px" src="./images/famlon.jpg"
                            ...
                            <div class="custom-block-info">
                                <a href="event-detail.html" class="align-items-center justify-content-center d-flex events-title mb-2">London Tour</a>
                    ...
                    <div class="col-lg-6 col-12 mb-5 mb-lg-4">
                        <div class="card border-0 position-relative rounded-top-5">
                            <a href="#" class="packagesImageWrapper">
                                ...
                                <img height="400px" src="./images/famd.jpg"
                                    class="card-img-top rounded-top-5" alt="...">
                            </a>
                            ...
                            <div class="custom-block-info">
                                <a href="event-detail.html" class="align-items-center justify-content-center d-flex events-title mb-2">Abu Dhabi Tour</a>
        ...
        <section class="events-section events-listing-section section-bg section-padding" id="section_3">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <h2 class="mb-3">Upcoming Family Travel Packages</h2>
                    </div>
