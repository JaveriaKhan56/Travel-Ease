...
?>
            ...
            <!-- <nav class="navbar navbar-expand-lg">                
                <div class="container">
                    <a class="navbar-brand d-flex align-items-center" href="..\TravelEase\index.php">
                        ...
                        <ul class="navbar-nav ms-lg-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                    <li><a class="dropdown-item" href="Our_Packages.php">Travel Packages</a></li>

                                    <li><a class="dropdown-item" href="event-detail.html">Travel Packages Details</a></li>
                                </ul>
                            </li>
                        </ul>

                        <div class="d-none d-lg-block ms-lg-3">
                            <a class="btn custom-btn custom-border-btn" data-bs-toggle="offcanvas" href="..\TravelEase\signUp.php" role="button" aria-controls="offcanvasExample">Sign-up</a>
                        </div>
                        
                        <div class="d-none d-lg-block ms-lg-3">
                            <a class="btn custom-btn custom-border-btn" data-bs-toggle="offcanvas" href="..\TravelEase\login.php" role="button" aria-controls="offcanvasExample">Login</a>
                        </div>
...
<!-- logIn -->
            <!-- <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel"> 
                ...
                <div class="offcanvas-header">
                    <h5 class="offcanvas-title" id="offcanvasExampleLabel">Login Up</h5>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                            <h2 class="text-white">Welcome to TravelEase</h2>
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/O4PmcP9ecE4?si=_JooI5ugo-nEfEmA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 text-center">
                            <h2 class="mb-lg-5 mb-4">About TravelEase</h2>
                        </div>

                        <div class="col-lg-5 col-12 me-auto mb-4 mb-lg-0">
                            <h3 class="mb-3">TravelEase History</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th scope="row" class="text-start">Basic</th>
    ...
    ?>
                        ...
                        <h4 class="mb-4 pb-lg-2">Please join us!</h4>
                            <form action="processMembership.php" method="post" class="custom-form membership-form shadow-lg" role="form">
                        ...
                        <div class="row custom-block mb-3">
                            ...
                            <div class="col-lg-6 col-12 order-3 order-lg-0">
                                <div class="custom-block-info mt-2 mt-lg-0">
                                    ...
                                    <p class="mb-0">TravelEAse provides expert, bespoke hockey packages for trips all over the world - for all travel types. Holland and Argentina are particularly popular destinations.</p>
                        ...
                        <div class="row custom-block custom-block-bg">
                            ...
                            <div class="col-lg-6 col-12 order-3 order-lg-0">
                                <div class="custom-block-info mt-2 mt-lg-0">
                                    ...
                                    <p class="mb-0">Here TravelEAse give some top-notch tips to ensure your next tournament trip is as smooth and enjoyable as possible.</p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12">
                            <form action="sentMailContact.php" method="post" class="custom-form contact-form" role="form">
                                <h2 class="mb-4 pb-2">Contact TravelEase</h2>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-12">
                        ...
                        <br>
                        <p class="copyright-text">Copyright © 2058 Travel Ease Club</p>
                    </div>
