        ...
        <main>
           ...
           <section class="events-section events-detail-section section-padding" id="section_2">
                ...
                if (isset($_GET['PackageID'])) {
                    $Id = mysqli_real_escape_string($conn, $_GET['PackageID']);
                    // $query = "SELECT * FROM travel_packages WHERE PackageID = $Id && PackageType= 'solo'";
                    $query = "SELECT 
    tp.PackageName, 
    tp.pkgImage, 
    tp.Details, 
...
FROM 
    travel_packages tp
INNER JOIN 
    cities c ON tp.CityID = c.CityID
INNER JOIN 
    countries co ON c.CountryID = co.CountryID
WHERE 
    tp.PackageID = $Id 
    AND tp.PackageType = 'family'";
                    ...
                    <div class="row">
                            ...
                            <h2 class="mb-lg-5 mb-4">' . $row['PackageName'] . ' Detail</h2>

                            <div class="custom-block-image-wrap">
                                <img src="static/images/' . $row['pkgImage'] . '" class="custom-block-image img-fluid" alt="">
                            </div>

                            <div class="custom-block-info">
                                <h3 class="mb-3">Includes all Complete Areas Deatils</h3>
                                ...
                                <div class="events-detail-info row my-5">
                                    <div class="col-lg-12 col-12">
                                        <h4 class="mb-3">Package Detail</h4>
                                    </div>
                                    <div class="col-lg-4 col-12">
                                        <span class="custom-block-span">Date:</span>
                                        <p class="mb-0">' . $row['StartDate'] . ' To ' . $row['EndDate'] . '</p>
                                    </div>
                                    <div class="col-lg-4 col-12 my-3 my-lg-0">
                                        <span class="custom-block-span">Location:</span>

                                        <p class="mb-0">' . $row['cityname'] . ', ' . $row['countryname'] . '</p>
                                    </div>
                                    <div class="col-lg-4 col-12 ">
